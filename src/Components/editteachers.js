...
function EditTeachers({state,setstate}){
    console.log(state)
    ...
    async function update(){
        ...
        let response = await fetch(`https://644b33c017e2663b9deab958.mockapi.io/student_teacher/${updatestudent.id}`, {
      method:"PUT",
    ...
    return(
        <Base
        title="Teachers Updation"
        content="Teachers deatils updated here !"
        >
